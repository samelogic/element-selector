...
selectionOverlay.style.pointerEvents = "none"; // Allow mouse events to pass through
...
function enableSelectionMode() {
  ...
  // Inform users that selection mode is active
...
function disableSelectionMode() {
  ...
  // Inform users that selection mode is deactivated
...
document.addEventListener("mouseout", function (event) {
  ...
  console.log("Mouseout event on:", event.target);
...
document.addEventListener(
  ...
  function (event) {
    ...
    try {
      ...
      console.log("Sent CSS Path to popup");
    } catch (error) {
...
document.addEventListener(
  ...
  function (event) {
    if (selecting && event.key === "Escape") {
      console.log("Escape key pressed - Cancelling selection mode");
      disableSelectionMode();
      ...
      try {
        ...
        console.error("Failed to send cancellation message to popup:", error);
      }

      // Inform users that the selection has been canceled
